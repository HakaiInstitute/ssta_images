...
clickedSite
  ...
  main.variable(observer("lineChart")).define("lineChart", ["Plot","clickedSite","colors","time1","d3","width","buoyClicked","siteClicked","colorView","md"], function(Plot,clickedSite,colors,time1,d3,width,buoyClicked,siteClicked,colorView,md)
{
  ...
  const SSTAlineChart = Plot.plot({
    ...
    marks: [
      ...
      Plot.text(
        [
          {
            x: clickedSite[Math.floor(clickedSite.length / 1.2)].date,
