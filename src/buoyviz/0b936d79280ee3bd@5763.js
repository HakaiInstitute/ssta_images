...
function _46(buoys,siteClickeds){return(
buoys.find((d) => d.long_name === siteClickeds).pk
)}

function _47(siteClickeds){return(
siteClickeds
)}
...
function _55(buoyDailyData){return(
...
function _77(monthlyTots){return(
...
function _84(dataSsta){return(
dataSsta["202203"]
)}

function _85(dataSstaOld){return(
dataSstaOld["202203"]
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["buoys","siteClickeds"], _46);
  main.variable(observer()).define(["siteClickeds"], _47);
  ...
  main.variable(observer()).define(["buoyDailyData"], _55);
  ...
  main.variable(observer()).define(["monthlyTots"], _77);
  ...
  main.variable(observer()).define(["dataSsta"], _84);
  main.variable(observer()).define(["dataSstaOld"], _85);
