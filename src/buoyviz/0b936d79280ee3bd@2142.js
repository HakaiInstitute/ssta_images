...
import define4 from "./2b837bccec7319ef@187.js";
...
Inputs.radio(["anomaly", "heat wave category"], {
  ...
  main.variable(observer("viewof limits")).define("viewof limits", ["brushFilterX","d3","dates"], function(brushFilterX,d3,dates){return(
brushFilterX(d3.extent(dates), {
  defaultExtent: [d3.isoParse("2015-01-01"), d3.isoParse("2015-06-01")]
})
)});
  ...
  main.variable(observer("leg")).define("leg", ["colorView","Plot","legend","d3"], function(colorView,Plot,legend,d3)
{
  ...
  main.variable(observer("lineChart")).define("lineChart", ["Plot","clickedSite","colors","time1","d3","width","colorView"], function(Plot,clickedSite,colors,time1,d3,width,colorView)
{
...
d3
  ...
  .range(["#a3a3a3", "#FEDB67", "#f26722", "#7E1416", "#cd3728"])
)});
