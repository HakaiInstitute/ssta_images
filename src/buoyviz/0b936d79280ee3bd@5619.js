...
function _36(focus){return(
focus
)}

function _37(d3,today){return(
...
function _drag(d3,x,focus,datesToPlot,$0)
{
  ...
  function dragged(event, d) {
    ...
    let isAboveMin = event.x < x(+new Date("2022-04-07"));
...
function _45(focus){return(
focus
)}

function _46(focusLong){return(
focusLong
)}
...
function _68(clickedSite){return(
...
function _88(dateExtent){return(
dateExtent[1]
)}

function _89(alldates){return(
alldates[111]
)}
...
function _94(groups){return(
groups
)}

function _95(monthlyGrouped){return(
monthlyGrouped[110]
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["focus"], _11);
  ...
  main.variable(observer()).define(["focus"], _32);
  ...
  main.variable(observer()).define(["focus"], _36);
  main.variable(observer()).define(["d3","today"], _37);
  ...
  main.variable(observer()).define(["focus"], _45);
  main.variable(observer()).define(["focusLong"], _46);
  main.variable(observer("brushedData")).define("brushedData", ["data","focus"], _brushedData);
  main.variable(observer()).define(["d3","focus"], _48);
  ...
  main.variable(observer()).define(["dataSsta"], _52);
  ...
  main.variable(observer()).define(["clickedSite"], _68);
  ...
  main.variable(observer()).define(["dateExtent"], _88);
  main.variable(observer()).define(["alldates"], _89);
  ...
  main.variable(observer()).define(["groups"], _94);
  main.variable(observer()).define(["monthlyGrouped"], _95);
