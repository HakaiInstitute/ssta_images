...
function _f(Player,numbers){return(
Player(numbers, {
  delay: 250,
  loop: false,
  show: { play: true }
...
function _Player(html,fas,bgc2,bgc,disposal){return(
function Player(
  values,
  {
    format = (value) => value,
  ...
  const btns = btnDesc.map(([x, kind]) => {
    ...
    return html`<button name=${x} class=button id=butt type=button >${icon}</button>`;
  });
...
function(x) {
  return html`<button name=p type=button class=button style="${sb}">${x}</button>`;
}
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["md","b"], _14);
  ...
  main.variable(observer()).define(["md","c"], _17);
  ...
  main.variable(observer()).define(["md","d"], _20);
  ...
  main.variable(observer()).define(["md","e"], _23);
  main.variable(observer()).define(["md"], _24);
  main.variable(observer("viewof f")).define("viewof f", ["Player","numbers"], _f);
  main.variable(observer("f")).define("f", ["Generators", "viewof f"], (G, _) => G.input(_));
  main.variable(observer()).define(["numbers"], _26);
  main.variable(observer()).define(["viewof f"], _27);
  main.variable(observer()).define(["md","f"], _28);
  ...
  main.variable(observer()).define(["md","g"], _30);
  main.variable(observer()).define(["md"], _31);
  main.variable(observer()).define(["html","letters","viewof f"], _32);
  main.variable(observer()).define(["html","viewof g"], _33);
  main.variable(observer()).define(["md"], _34);
  main.variable(observer("Player")).define("Player", ["html","fas","bgc2","bgc","disposal"], _Player);
