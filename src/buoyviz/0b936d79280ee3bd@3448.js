...
colorView
  ...
  main.variable(observer("datesToPlot")).define("datesToPlot", ["datesCopy","limits","d3"], function(datesCopy,limits,d3){return(
datesCopy.filter(
  (d) => d >= limits[0] && d <= d3.timeDay.offset(limits[1], 1)
)
)});
