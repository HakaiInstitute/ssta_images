...
function _brushFilterX(d3,width,alldates,hwEvent,Event){return(
function (
  extent,
  {
    defaultExtent,
...
function _36(dates){return(
dates
)}

function _37(time1){return(
time1
)}

function _38(alldates){return(
alldates
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([["monthly@5.json",new URL("./files/c4804cd494f0b96ac2d3b47dc33a672726905b0b035715b118da85af025b1b3bdfaca838961ca5e2847c4d71dd58f384bd53f4b3205dbdd64ff6d909a7c46815",import.meta.url)]]);
  ...
  main.variable(observer("brushFilterX")).define("brushFilterX", ["d3","width","alldates","hwEvent","Event"], _brushFilterX);
  ...
  main.variable(observer()).define(["d3","today"], _31);
  ...
  main.variable(observer()).define(["dates"], _36);
  main.variable(observer()).define(["time1"], _37);
  main.variable(observer()).define(["alldates"], _38);
  ...
  main.variable(observer()).define(["colorView"], _41);
  ...
  main.variable(observer()).define(["Plot"], _49);
