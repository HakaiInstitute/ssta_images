...
function _brushFilterX(d3,width,alldates,textures,hwEvent,Event){return(
function (
  extent,
  {
    defaultExtent,
...
function _time1(Scrubber,datesToPlot){return(
...
function _33(Plot,clickedSite,colors,time1,d3){return(
Plot.plot({
  style: {
    backgroundColor: "#000000",
    color: "#e0f5ee",
...
function _lineChart(Plot,clickedSite,colors,time1,d3,limitsDelayed,yMaxDomainToUse,dateForLabel,yValueForLabel,buoyClicked,siteClicked,colorView,md)
{
...
function _38(d3,clickedSite){return(
d3.max(clickedSite, (d) => d.sst) * 1.1
)}

function _Minimap(){return(
...
function _44(clickedSite){return(
...
function _59(buoyDailyData){return(
buoyDailyData
)}
...
function _65(buoyDailyData){return(
buoyDailyData.filter((d) => d.category === "Strong")
)}

function _66(dateExtent){return(
...
function _71(limits){return(
limits[0]
)}

function _73(limits){return(
limits
)}

function _74(dayBeforeStart){return(
dayBeforeStart
)}
...
function _91(opacityMHW){return(
opacityMHW("none")
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["limits"], _13);
  ...
  main.variable(observer("brushFilterX")).define("brushFilterX", ["d3","width","alldates","textures","hwEvent","Event"], _brushFilterX);
  ...
  main.variable(observer()).define(["colorView"], _19);
  ...
  main.variable(observer("viewof time1")).define("viewof time1", ["Scrubber","datesToPlot"], _time1);
  main.variable(observer("time1")).define("time1", ["Generators", "viewof time1"], (G, _) => G.input(_));
  main.variable(observer()).define(["limits"], _28);
  ...
  main.variable(observer()).define(["Plot","clickedSite","colors","time1","d3"], _33);
  ...
  main.variable(observer("viewof lineChart")).define("viewof lineChart", ["Plot","clickedSite","colors","time1","d3","limitsDelayed","yMaxDomainToUse","dateForLabel","yValueForLabel","buoyClicked","siteClicked","colorView","md"], _lineChart);
  main.variable(observer("lineChart")).define("lineChart", ["Generators", "viewof lineChart"], (G, _) => G.input(_));
  main.variable(observer()).define(["width"], _36);
  main.variable(observer()).define(["clickedSite"], _37);
  main.variable(observer()).define(["d3","clickedSite"], _38);
  main.variable(observer("Minimap")).define("Minimap", _Minimap);
  main.variable(observer()).define(["buoys"], _40);
  ...
  main.variable(observer()).define(["clickedSite"], _44);
  ...
  main.variable(observer()).define(["buoyDailyData"], _59);
  ...
  main.variable(observer()).define(["buoyDailyData"], _65);
  main.variable(observer()).define(["dateExtent"], _66);
  ...
  main.variable(observer()).define(["limits"], _69);
  main.variable(observer("dayBeforeStart")).define("dayBeforeStart", ["limits"], _dayBeforeStart);
  main.variable(observer()).define(["limits"], _71);
  main.variable(observer()).define(["limits"], _73);
  main.variable(observer()).define(["dayBeforeStart"], _74);
  ...
  main.variable(observer()).define(["opacityMHW"], _91);
