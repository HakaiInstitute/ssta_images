...
function _64(buoys,siteClickeds){return(
buoys.find((d) => d.long_name === siteClickeds).pk
)}

function _65(siteClickeds){return(
siteClickeds
)}
...
function _76(buoyDailyData){return(
...
function _98(monthlyTots){return(
...
function _105(dataSsta){return(
dataSsta["202203"]
)}

function _106(dataSstaOld){return(
dataSstaOld["202204"]
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["buoys","siteClickeds"], _64);
  main.variable(observer()).define(["siteClickeds"], _65);
  ...
  main.variable(observer()).define(["buoyDailyData"], _76);
  ...
  main.variable(observer()).define(["monthlyTots"], _98);
  ...
  main.variable(observer()).define(["dataSsta"], _105);
  main.variable(observer()).define(["dataSstaOld"], _106);
