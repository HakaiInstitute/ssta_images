...
function _86(dateExtent){return(
dateExtent[1]
)}

function _87(alldates){return(
alldates[111]
)}
...
function _90(monthlyTots){return(
...
function _92(groups){return(
groups
)}

function _93(monthlyGrouped){return(
monthlyGrouped[110]
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["dateExtent"], _86);
  main.variable(observer()).define(["alldates"], _87);
  ...
  main.variable(observer()).define(["monthlyTots"], _90);
  main.variable(observer("monthlyTots")).define("monthlyTots", ["allmonths","cats","d3","mhwBarData"], _monthlyTots);
  main.variable(observer()).define(["groups"], _92);
  main.variable(observer()).define(["monthlyGrouped"], _93);
