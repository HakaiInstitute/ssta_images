...
function _52(stack,brushedDataMHW){return(
stack(brushedDataMHW)
)}
...
function _64(dates){return(
dates
)}

function _65(time1){return(
time1
)}

function _66(alldates){return(
alldates
)}
...
function _80(Inputs,clickedSite){return(
...
function _86(clickedSite){return(
...
function _100(buoyDailyData){return(
buoyDailyData
)}

function _104(time1){return(
...
function _106(buoyDailyData){return(
buoyDailyData.filter((d) => d.category === "Strong")
)}

function _107(dateExtent){return(
...
function _112(dayBeforeStart){return(
dayBeforeStart
)}
...
function _129(opacityMHW){return(
opacityMHW("none")
)}
...
function _148(mhwBarData){return(
mhwBarData[0].date.slice(0, 7)
)}

function _149(d3,mhwBarData,allmonths,cats){return(
d3.sum(
...
function _152(monthlyTots){return(
monthlyTots.filter((d) => d.date === "2013-01")
)}

function _153(){return(
14410255 + 824985 + 3215 + 478
)}

function _154(allmonths){return(
allmonths
)}
...
function _156(groups){return(
groups
)}

function _157(){return(
12617969 + 1112284 + 34560 + 328
)}

function _158(groups){return(
groups[1][1]
)}
...
function _162(d3,groups){return(
...
function _168(mhwBarData){return(
new Date(mhwBarData[0].date).getMonth()
)}

function _170(tt){return(
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["stack","brushedDataMHW"], _52);
  ...
  main.variable(observer()).define(["d3","today"], _59);
  ...
  main.variable(observer()).define(["dates"], _64);
  main.variable(observer()).define(["time1"], _65);
  main.variable(observer()).define(["alldates"], _66);
  ...
  main.variable(observer()).define(["time1"], _77);
  main.variable(observer()).define(["time1"], _78);
  main.variable(observer()).define(["clickedSite"], _79);
  main.variable(observer()).define(["Inputs","clickedSite"], _80);
  ...
  main.variable(observer()).define(["clickedSite"], _86);
  ...
  main.variable(observer()).define(["buoyDailyData"], _100);
  main.variable(observer()).define(["time1"], _104);
  main.variable(observer("HWsForDate")).define("HWsForDate", ["buoyDailyData","time1"], _HWsForDate);
  main.variable(observer()).define(["buoyDailyData"], _106);
  main.variable(observer()).define(["dateExtent"], _107);
  ...
  main.variable(observer()).define(["dayBeforeStart"], _112);
  ...
  main.variable(observer()).define(["opacityMHW"], _129);
  ...
  main.variable(observer()).define(["mhwBarData"], _148);
  main.variable(observer()).define(["d3","mhwBarData","allmonths","cats"], _149);
  main.variable(observer()).define(["cats"], _150);
  main.variable(observer("allmonths")).define("allmonths", ["mhwBarData"], _allmonths);
  main.variable(observer()).define(["monthlyTots"], _152);
  main.variable(observer()).define(_153);
  main.variable(observer()).define(["allmonths"], _154);
  main.variable(observer("monthlyTots")).define("monthlyTots", ["allmonths","cats","d3","mhwBarData"], _monthlyTots);
  main.variable(observer()).define(["groups"], _156);
  main.variable(observer()).define(_157);
  main.variable(observer()).define(["groups"], _158);
  ...
  main.variable(observer()).define(["d3","groups"], _162);
  ...
  main.variable(observer()).define(["mhwBarData"], _168);
  main.variable(observer()).define(["tt"], _170);
