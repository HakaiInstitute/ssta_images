...
function _79(Inputs,clickedSite){return(
...
function _82(clickedSite){return(
clickedSite.length
)}
...
function _lineChart(clickedSite,Plot,limitsDelayed,yMaxDomainToUse,time1,d3,dateForLabel,yValueForLabel,buoyClicked,colors,dateForLabelVal,currentValue,siteClicked,colorView,md)
{
  ...
  const taLabel = clickedSite.length === 0 ? "" : "temp. anomaly";
...
function _91(buoyDailyData){return(
buoyDailyData
)}
...
function _102(buoyDailyData){return(
buoyDailyData
)}

function _106(time1){return(
...
function _108(buoyDailyData){return(
buoyDailyData.filter((d) => d.category === "Strong")
)}

function _109(dateExtent){return(
...
function _114(dayBeforeStart){return(
dayBeforeStart
)}
...
function _131(opacityMHW){return(
opacityMHW("none")
)}
...
function _150(mhwBarData){return(
mhwBarData[0].date.slice(0, 7)
)}

function _151(d3,mhwBarData,allmonths,cats){return(
d3.sum(
...
function _154(monthlyTots){return(
monthlyTots.filter((d) => d.date === "2013-01")
)}

function _155(){return(
14410255 + 824985 + 3215 + 478
)}

function _156(allmonths){return(
allmonths
)}
...
function _162(groups){return(
groups[1][1].forEach((d) => {
  Object.values(d)[1];
})
)}

function _163(groups)
{
  let sum = 0;
  groups[1][1].forEach((d) => {
...
function _164(d3,groups){return(
...
function _170(mhwBarData){return(
new Date(mhwBarData[0].date).getMonth()
)}

function _172(tt){return(
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["Inputs","clickedSite"], _79);
  ...
  main.variable(observer()).define(["clickedSite"], _82);
  ...
  main.variable(observer()).define(["buoyDailyData"], _91);
  ...
  main.variable(observer()).define(["buoyDailyData"], _102);
  main.variable(observer()).define(["time1"], _106);
  main.variable(observer("HWsForDate")).define("HWsForDate", ["buoyDailyData","time1"], _HWsForDate);
  main.variable(observer()).define(["buoyDailyData"], _108);
  main.variable(observer()).define(["dateExtent"], _109);
  ...
  main.variable(observer()).define(["dayBeforeStart"], _114);
  ...
  main.variable(observer()).define(["opacityMHW"], _131);
  ...
  main.variable(observer()).define(["mhwBarData"], _150);
  main.variable(observer()).define(["d3","mhwBarData","allmonths","cats"], _151);
  main.variable(observer()).define(["cats"], _152);
  main.variable(observer("allmonths")).define("allmonths", ["mhwBarData"], _allmonths);
  main.variable(observer()).define(["monthlyTots"], _154);
  main.variable(observer()).define(_155);
  main.variable(observer()).define(["allmonths"], _156);
  ...
  main.variable(observer()).define(_159);
  ...
  main.variable(observer()).define(["groups"], _163);
  main.variable(observer()).define(["d3","groups"], _164);
  ...
  main.variable(observer()).define(["mhwBarData"], _170);
  main.variable(observer()).define(["tt"], _172);
