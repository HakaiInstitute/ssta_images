...
clickedSite
  ...
  main.variable(observer("lineChart")).define("lineChart", ["Plot","clickedSite","colors","time1","d3","width","siteClicked","colorView","md"], function(Plot,clickedSite,colors,time1,d3,width,siteClicked,colorView,md)
{
