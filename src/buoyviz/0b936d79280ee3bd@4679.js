...
function _lineChart(Plot,clickedSite,colors,time1,d3,dateForLabel,yValueForLabel,buoyClicked,limitsDelayed,yMaxDomainToUse,dateForLabelVal,currentValue,siteClicked,colorView,md)
{
...
function _58(clickedSite){return(
...
function _78(buoyDailyData){return(
buoyDailyData.filter((d) => d.category === "Strong")
)}

function _79(dateExtent){return(
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("viewof lineChart")).define("viewof lineChart", ["Plot","clickedSite","colors","time1","d3","dateForLabel","yValueForLabel","buoyClicked","limitsDelayed","yMaxDomainToUse","dateForLabelVal","currentValue","siteClicked","colorView","md"], _lineChart);
  ...
  main.variable(observer()).define(["clickedSite"], _58);
  ...
  main.variable(observer()).define(["buoyDailyData"], _78);
  main.variable(observer()).define(["dateExtent"], _79);
  ...
  main.variable(observer()).define(["limits"], _82);
  ...
  main.variable(observer()).define(["limits"], _86);
