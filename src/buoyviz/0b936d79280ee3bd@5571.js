...
function _43(focus){return(
focus
)}

function _44(focusLong){return(
focusLong
)}
...
function _85(dateExtent){return(
dateExtent[1]
)}

function _86(alldates){return(
alldates[111]
)}
...
function _89(monthlyTots){return(
...
function _91(groups){return(
groups
)}

function _92(monthlyGrouped){return(
monthlyGrouped[110]
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["focus"], _30);
  ...
  main.variable(observer()).define(["d3","today"], _35);
  main.variable(observer("drag")).define("drag", ["d3","x","focus","datesToPlot","viewof time1"], _drag);
  main.variable(observer()).define(["focus"], _37);
  ...
  main.variable(observer()).define(["focus"], _43);
  main.variable(observer()).define(["focusLong"], _44);
  main.variable(observer("brushedData")).define("brushedData", ["data","focus"], _brushedData);
  main.variable(observer()).define(["d3","focus"], _46);
  ...
  main.variable(observer()).define(["dataSsta"], _50);
  ...
  main.variable(observer()).define(["dateExtent"], _85);
  main.variable(observer()).define(["alldates"], _86);
  ...
  main.variable(observer()).define(["monthlyTots"], _89);
  main.variable(observer("monthlyTots")).define("monthlyTots", ["allmonths","cats","d3","mhwBarData"], _monthlyTots);
  main.variable(observer()).define(["groups"], _91);
  main.variable(observer()).define(["monthlyGrouped"], _92);
