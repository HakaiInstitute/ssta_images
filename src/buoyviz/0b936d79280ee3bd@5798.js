...
function _drag(d3,x,focus,datesToPlot,$0)
{
  ...
  function dragged(event, d) {
    ...
    let isAboveMin = event.x < x(+new Date("2022-05-01"));
...
function _47(buoys,siteClickeds){return(
buoys.find((d) => d.long_name === siteClickeds).pk
)}

function _48(siteClickeds){return(
siteClickeds
)}
...
function _56(buoyDailyData){return(
...
function _78(monthlyTots){return(
...
function _85(dataSsta){return(
dataSsta["202203"]
)}

function _86(dataSstaOld){return(
dataSstaOld["202203"]
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["focus"], _8);
  ...
  main.variable(observer()).define(["buoys","siteClickeds"], _47);
  main.variable(observer()).define(["siteClickeds"], _48);
  ...
  main.variable(observer()).define(["buoyDailyData"], _56);
  ...
  main.variable(observer()).define(["monthlyTots"], _78);
  ...
  main.variable(observer()).define(["dataSsta"], _85);
  main.variable(observer()).define(["dataSstaOld"], _86);
