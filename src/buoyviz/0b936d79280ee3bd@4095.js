...
Player(datesToPlot, {
  width: 300, //Math.min(555, width - 30),
  // margin: 500,
  delay: 100,
  autoplay: false,
  loop: false,
...
function _17(d3,datesToPlot){return(
d3.bisect(datesToPlot, 1578158090036)
)}

function _18(md){return(
md`How many pixels wide is the bar?
${908-95}
How many days of images do we have?
${9*365}`
)}

function _19(datesToPlot){return(
datesToPlot[0]
)}

function _20(d3,dates){return(
d3.extent(dates)
)}

function _21(datesToPlot){return(
datesToPlot
)}

function _22(alldates){return(
alldates
)}

function _24(limits){return(
limits
)}
...
function _brushFilterXDot(d3,width,alldates,time1,limits,datesToPlot,$0){return(
function (
  extent,
  {
    defaultExtent,
...
function _51(clickedSite){return(
...
function _66(buoyDailyData){return(
buoyDailyData
)}

function _70(time1){return(
...
function _72(buoyDailyData){return(
buoyDailyData.filter((d) => d.category === "Strong")
)}

function _73(dateExtent){return(
...
function _78(limits){return(
limits[0]
)}

function _80(limits){return(
limits
)}

function _81(dayBeforeStart){return(
dayBeforeStart
)}
...
function _98(opacityMHW){return(
opacityMHW("none")
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["time1"], _15);
  main.variable(observer()).define(_16);
  main.variable(observer()).define(["d3","datesToPlot"], _17);
  main.variable(observer()).define(["md"], _18);
  main.variable(observer()).define(["datesToPlot"], _19);
  main.variable(observer()).define(["d3","dates"], _20);
  main.variable(observer()).define(["datesToPlot"], _21);
  main.variable(observer()).define(["alldates"], _22);
  const child1 = runtime.module(define1);
  main.import("Player", child1);
  main.variable(observer()).define(["limits"], _24);
  ...
  main.variable(observer()).define(["width"], _27);
  ...
  main.variable(observer("brushFilterXDot")).define("brushFilterXDot", ["d3","width","alldates","time1","limits","datesToPlot","viewof time1"], _brushFilterXDot);
  ...
  main.variable(observer()).define(["Plot"], _45);
  ...
  main.variable(observer()).define(["clickedSite"], _51);
  ...
  main.variable(observer()).define(["buoyDailyData"], _66);
  main.variable(observer()).define(["time1"], _70);
  main.variable(observer("HWsForDate")).define("HWsForDate", ["buoyDailyData","time1"], _HWsForDate);
  main.variable(observer()).define(["buoyDailyData"], _72);
  main.variable(observer()).define(["dateExtent"], _73);
  ...
  main.variable(observer()).define(["limits"], _76);
  main.variable(observer("dayBeforeStart")).define("dayBeforeStart", ["limits"], _dayBeforeStart);
  main.variable(observer()).define(["limits"], _78);
  main.variable(observer()).define(["limits"], _80);
  main.variable(observer()).define(["dayBeforeStart"], _81);
  ...
  main.variable(observer()).define(["opacityMHW"], _98);
