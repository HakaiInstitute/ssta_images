import define1 from "./41364653f34651d0@442.js";
...
function _30(clickedSite,alldays){return(
clickedSite.find((d) => +d.date === +new Date(alldays[0]))
)}

function _31(tempToShow){return(
...
function _49(monthlyGrouped){return(
monthlyGrouped
)}
...
function _65(buoys,siteClickeds){return(
buoys.find((d) => d.long_name === siteClickeds).pk
)}

function _66(siteClickeds){return(
siteClickeds
)}
...
function _77(buoyDailyData){return(
...
function _99(monthlyTots){return(
...
function _106(dataSsta){return(
dataSsta["202203"]
)}

function _107(dataSsta){return(
dataSsta["202207"]
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["alldays"], _28);
  main.variable(observer()).define(["alldays"], _29);
  main.variable(observer()).define(["clickedSite","alldays"], _30);
  main.variable(observer()).define(["tempToShow"], _31);
  ...
  main.variable(observer()).define(["monthlyGrouped"], _49);
  ...
  main.variable(observer()).define(["buoys","siteClickeds"], _65);
  main.variable(observer()).define(["siteClickeds"], _66);
  ...
  main.variable(observer()).define(["time1"], _69);
  ...
  main.variable(observer()).define(["buoyDailyData"], _77);
  ...
  main.variable(observer()).define(["monthlyTots"], _99);
  ...
  main.variable(observer()).define(["dataSsta"], _106);
  main.variable(observer()).define(["dataSsta"], _107);
