...
function _5(datesToPlot){return(
new Date(datesToPlot[342])
)}
...
function _drag(d3,x,focus,endPlayDate,datesToPlot,$0)
{
...
function _51(buoys,siteClickeds){return(
buoys.find((d) => d.long_name === siteClickeds).pk
)}

function _52(siteClickeds){return(
siteClickeds
)}
...
function _60(buoyDailyData){return(
...
function _82(monthlyTots){return(
...
function _89(dataSsta){return(
dataSsta["202203"]
)}

function _90(dataSstaOld){return(
dataSstaOld["202204"]
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["monthlyMHW.json", {url: new URL("./files/4f15d9ec1bd1193a40e6cccc638b5ebbef045d555e511f1e5b1b631be853554576b6519c5cbbb167076801ccadcfb6c355a2ccc8f3cdbedc96be1debbb74c2e2", import.meta.url), mimeType: "application/json", toString}],
    ["monthly@7.json", {url: new URL("./files/a3fbadf29709e974764d626a8843acf9134d9d813173218a60e5bbdf612fc8f873cb8fc46bf03b10d42dff7e66f3861625456633c0b887fee99eb6c0c0ac42d9", import.meta.url), mimeType: "application/json", toString}]
  ]);
  ...
  main.variable(observer()).define(["datesToPlot"], _5);
  ...
  main.variable(observer()).define(["focus"], _12);
  ...
  main.variable(observer("drag")).define("drag", ["d3","x","focus","endPlayDate","datesToPlot","viewof time1"], _drag);
  ...
  main.variable(observer()).define(["buoys","siteClickeds"], _51);
  main.variable(observer()).define(["siteClickeds"], _52);
  ...
  main.variable(observer()).define(["buoyDailyData"], _60);
  ...
  main.variable(observer()).define(["monthlyTots"], _82);
  ...
  main.variable(observer()).define(["dataSsta"], _89);
  main.variable(observer()).define(["dataSstaOld"], _90);
