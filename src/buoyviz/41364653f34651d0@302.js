// https://observablehq.com/@mbrownshoes/stylized-scrubber@302
...
function Scrubber(
  ...
  const form = html`<form style="font: 12px var(--sans-serif); font-variant-numeric: tabular-nums; display: flex; height: 103px; align-items: center;">
