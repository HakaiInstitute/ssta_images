...
function _17(brushedData){return(
brushedData[brushedData.length - 1]
)}

function _18(dateExtent){return(
dateExtent
)}

function _19(time1){return(
new Date(time1)
)}
...
function _35(dates){return(
dates
)}

function _36(time1){return(
time1
)}

function _37(alldates){return(
alldates
)}
...
function _50(time1){return(
time1
)}

function _51(time1){return(
...
function _53(Inputs,clickedSite){return(
...
function _56(Plot,limitsDelayed,yMaxDomainToUse,clickedSite,time1,d3,dateForLabel,yValueForLabel,buoyClicked,colors){return(
Plot.plot({
  x: {
    domain: [limitsDelayed[0], limitsDelayed[1]]
  },
...
function _60(clickedSite){return(
...
function _74(buoyDailyData){return(
buoyDailyData
)}
...
function _80(buoyDailyData){return(
buoyDailyData.filter((d) => d.category === "Strong")
)}

function _81(dateExtent){return(
...
function _87(dayBeforeStart){return(
dayBeforeStart
)}
...
function _104(opacityMHW){return(
opacityMHW("none")
)}
...
function _123(mhwBarData){return(
mhwBarData
)}
...
async function _mhwBarData(FileAttachment)
{
  ...
  const cats = ["none", "one", "two", "three", "four"];
  const out = [];
  Object.keys(raw).forEach((d) => {
    for (let i = 0; i < 5; i++) {
      out.push({ date: d, level: cats[i] });
    }
  });
  return out;
}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["time1"], _6);
  ...
  main.variable(observer()).define(["brushedData"], _17);
  main.variable(observer()).define(["dateExtent"], _18);
  main.variable(observer()).define(["time1"], _19);
  ...
  main.variable(observer()).define(["d3","today"], _30);
  ...
  main.variable(observer()).define(["dates"], _35);
  main.variable(observer()).define(["time1"], _36);
  main.variable(observer()).define(["alldates"], _37);
  ...
  main.variable(observer()).define(["colorView"], _40);
  ...
  main.variable(observer()).define(["Plot"], _48);
  ...
  main.variable(observer()).define(["time1"], _50);
  main.variable(observer()).define(["time1"], _51);
  main.variable(observer()).define(["clickedSite"], _52);
  main.variable(observer()).define(["Inputs","clickedSite"], _53);
  ...
  main.variable(observer()).define(["Plot","limitsDelayed","yMaxDomainToUse","clickedSite","time1","d3","dateForLabel","yValueForLabel","buoyClicked","colors"], _56);
  ...
  main.variable(observer()).define(["clickedSite"], _60);
  ...
  main.variable(observer()).define(["buoyDailyData"], _74);
  ...
  main.variable(observer()).define(["buoyDailyData"], _80);
  main.variable(observer()).define(["dateExtent"], _81);
  ...
  main.variable(observer()).define(["limits"], _84);
  main.variable(observer("dayBeforeStart")).define("dayBeforeStart", ["focus"], _dayBeforeStart);
  main.variable(observer()).define(["dayBeforeStart"], _87);
  ...
  main.variable(observer()).define(["opacityMHW"], _104);
  ...
  main.variable(observer()).define(["mhwBarData"], _123);
