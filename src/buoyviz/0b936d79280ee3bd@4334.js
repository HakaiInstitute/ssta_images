import define1 from "./d7a850070813db1b@982.js";
...
function _35(brushedData){return(
brushedData
)}
...
function _37(dateExtent){return(
dateExtent
)}
...
function _chart(focusHeight,d3,width,margin,focus,brusedAllDates,brushedData,sstaColors,time1,datesToPlot,$0)
{
  ...
  function dragged(event, d) {
    // console.log(event.x, x(+focus[1]));
    let isBelowMax = event.x >= x(+focus[0]);
    let isAboveMin = event.x <= x(+focus[1]);
...
Player(datesToPlot, {
  width: 110, //Math.min(555, width - 30),
  // margin: 500,
  delay: 100,
  autoplay: false,
  loop: false,
...
function _53(dates){return(
dates
)}

function _54(time1){return(
time1
)}

function _55(alldates){return(
alldates
)}
...
function _84(buoyDailyData){return(
buoyDailyData
)}

function _88(time1){return(
...
function _90(buoyDailyData){return(
buoyDailyData.filter((d) => d.category === "Strong")
)}

function _91(dateExtent){return(
...
function _99(dayBeforeStart){return(
dayBeforeStart
)}
...
function _116(opacityMHW){return(
opacityMHW("none")
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["brushedData"], _35);
  main.variable(observer()).define(["brushedData"], _36);
  main.variable(observer()).define(["dateExtent"], _37);
  ...
  main.variable(observer("chart")).define("chart", ["focusHeight","d3","width","margin","focus","brusedAllDates","brushedData","sstaColors","time1","datesToPlot","viewof time1"], _chart);
  ...
  main.variable(observer()).define(["d3","today"], _45);
  ...
  main.variable(observer()).define(["dates"], _53);
  main.variable(observer()).define(["time1"], _54);
  main.variable(observer()).define(["alldates"], _55);
  ...
  main.variable(observer()).define(["colorView"], _58);
  ...
  main.variable(observer()).define(["limits"], _63);
  ...
  main.variable(observer()).define(["Plot"], _66);
  ...
  main.variable(observer()).define(["buoyDailyData"], _84);
  main.variable(observer()).define(["time1"], _88);
  main.variable(observer("HWsForDate")).define("HWsForDate", ["buoyDailyData","time1"], _HWsForDate);
  main.variable(observer()).define(["buoyDailyData"], _90);
  main.variable(observer()).define(["dateExtent"], _91);
  ...
  main.variable(observer()).define(["limits"], _94);
  main.variable(observer("dayBeforeStart")).define("dayBeforeStart", ["focus"], _dayBeforeStart);
  main.variable(observer()).define(["limits"], _96);
  main.variable(observer()).define(["limits"], _98);
  main.variable(observer()).define(["dayBeforeStart"], _99);
  ...
  main.variable(observer()).define(["opacityMHW"], _116);
