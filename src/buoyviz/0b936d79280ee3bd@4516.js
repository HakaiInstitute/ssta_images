...
function _19(focus){return(
focus
)}

function _20(time1){return(
new Date(time1)
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["focus"], _19);
  main.variable(observer()).define(["time1"], _20);
  ...
  main.variable(observer()).define(["limits"], _45);
