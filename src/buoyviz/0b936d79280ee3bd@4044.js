...
function _10(limits){return(
limits
)}

function _11(datesToPlot){return(
datesToPlot
)}
...
function _18(datesToPlot){return(
datesToPlot[0]
)}
...
function _28(dates){return(
dates
)}

function _29(time1){return(
time1
)}

function _30(alldates){return(
alldates
)}
...
function _47(clickedSite){return(
...
function _62(buoyDailyData){return(
buoyDailyData
)}

function _66(time1){return(
...
function _68(buoyDailyData){return(
buoyDailyData.filter((d) => d.category === "Strong")
)}

function _69(dateExtent){return(
...
function _77(dayBeforeStart){return(
dayBeforeStart
)}
...
function _94(opacityMHW){return(
opacityMHW("none")
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["limits"], _10);
  main.variable(observer()).define(["datesToPlot"], _11);
  ...
  main.variable(observer()).define(["datesToPlot"], _18);
  main.variable(observer()).define(["d3","dates"], _19);
  const child1 = runtime.module(define1);
  main.import("Player", child1);
  main.variable(observer()).define(["limits"], _21);
  ...
  main.variable(observer()).define(["dates"], _28);
  main.variable(observer()).define(["time1"], _29);
  main.variable(observer()).define(["alldates"], _30);
  ...
  main.variable(observer()).define(["colorView"], _33);
  ...
  main.variable(observer()).define(["limits"], _38);
  ...
  main.variable(observer()).define(["Plot"], _41);
  ...
  main.variable(observer()).define(["clickedSite"], _47);
  ...
  main.variable(observer()).define(["buoyDailyData"], _62);
  main.variable(observer()).define(["time1"], _66);
  main.variable(observer("HWsForDate")).define("HWsForDate", ["buoyDailyData","time1"], _HWsForDate);
  main.variable(observer()).define(["buoyDailyData"], _68);
  main.variable(observer()).define(["dateExtent"], _69);
  ...
  main.variable(observer()).define(["limits"], _72);
  ...
  main.variable(observer()).define(["dayBeforeStart"], _77);
  ...
  main.variable(observer()).define(["opacityMHW"], _94);
