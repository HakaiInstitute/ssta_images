...
function _time1(Player,datesToPlot,width){return(
Player(datesToPlot, {
  width: Math.min(555, width - 30),
  delay: 100,
  autoplay: false,
  loop: false,
  show: { play: true },
...
function _30(dates){return(
dates
)}

function _31(time1){return(
time1
)}

function _32(alldates){return(
alldates
)}
...
function _49(clickedSite){return(
...
function _64(buoyDailyData){return(
buoyDailyData
)}

function _68(time1){return(
...
function _71(dateExtent){return(
...
function _79(dayBeforeStart){return(
dayBeforeStart
)}
...
function _96(opacityMHW){return(
opacityMHW("none")
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("viewof time1")).define("viewof time1", ["Player","datesToPlot","width"], _time1);
  ...
  main.variable(observer()).define(["limits"], _22);
  ...
  main.variable(observer()).define(["width"], _25);
  ...
  main.variable(observer()).define(["dates"], _30);
  main.variable(observer()).define(["time1"], _31);
  main.variable(observer()).define(["alldates"], _32);
  ...
  main.variable(observer()).define(["colorView"], _35);
  ...
  main.variable(observer()).define(["limits"], _40);
  ...
  main.variable(observer()).define(["Plot"], _43);
  ...
  main.variable(observer()).define(["clickedSite"], _49);
  ...
  main.variable(observer()).define(["buoyDailyData"], _64);
  main.variable(observer()).define(["time1"], _68);
  ...
  main.variable(observer()).define(["dateExtent"], _71);
  ...
  main.variable(observer()).define(["limits"], _74);
  ...
  main.variable(observer()).define(["dayBeforeStart"], _79);
  ...
  main.variable(observer()).define(["opacityMHW"], _96);
