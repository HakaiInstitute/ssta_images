...
function _16(brusedAllDatesMHW){return(
brusedAllDatesMHW
)}
...
function _22(brushedData){return(
brushedData[brushedData.length - 1]
)}

function _23(dateExtent){return(
dateExtent
)}

function _24(time1){return(
new Date(time1)
)}

function _drag(d3,x,focus,today,datesToPlot,$0)
{
  ...
  function dragged(event, d) {
    ...
    let isAboveMin = event.x < x(+d3.timeDay.offset(today, -1));
    // console.log(isAboveMin);
...
function _29(cats){return(
cats
)}

function _30(groups){return(
groups[0][1][1]
)}

function _31(monthlyTots){return(
monthlyTots
)}

function _32(mhwBarData){return(
mhwBarData
)}

function _33(colors){return(
colors
)}

function _34(data){return(
data[109]
)}

function _35(mhwBarData){return(
Object.keys(mhwBarData[0]).slice(1)
)}

function _36(stack,mhwBarData){return(
stack(mhwBarData)[1]
)}

function _37(mhwBarData){return(
mhwBarData
)}
...
function _39(stack,brushedDataMHW){return(
stack(brushedDataMHW)
)}

function _40(mhwBarData){return(
Object.keys(mhwBarData[0]).slice(1)
)}

function _41(cats){return(
cats
)}

function _42(dateExtent){return(
dateExtent
)}

function _43(monthlyGrouped){return(
monthlyGrouped
)}

function _44(stack,monthlyGrouped){return(
stack(monthlyGrouped)
)}

function _45(brusedAllDatesMHW){return(
brusedAllDatesMHW
)}
...
function _47(brusedAllDates){return(
brusedAllDates
)}

function _48(colorView){return(
colorView
)}
...
function _chart(colorView,focusHeight,d3,width,margin,xMHW,stack,brushedDataMHW,colors,x1MHW,time1,x,drag,brusedAllDates,brushedData,sstaColors)
{
  if (colorView === "Heatwaves") {
    ...
    // const brusedAllDates = d3.timeMonth
    //   .range(new Date(focusMHW[0]), new Date(focusMHW[1]))
    //   .map((d) => d.toISOString().substring(0, 10));
...
function _51(stack,brushedDataMHW){return(
stack(brushedDataMHW)
)}
...
FileAttachment("monthly@5.json").json()
)}

function _63(dates){return(
dates
)}

function _64(time1){return(
time1
)}

function _65(alldates){return(
alldates
)}
...
function _78(time1){return(
time1
)}

function _79(time1){return(
new Date(time1).getMonth()
)}

function _80(clickedSite){return(
new Date(clickedSite[0].date).toISOString().substring(0, 10)
)}

function _81(Inputs,clickedSite){return(
Inputs.table(clickedSite)
)}

function _currentValue(clickedSite,time1)
{
  let value = clickedSite
    .find(
      (d) =>
...
function _lineChart(Plot,limitsDelayed,yMaxDomainToUse,clickedSite,time1,d3,dateForLabel,yValueForLabel,buoyClicked,colors,dateForLabelVal,currentValue,siteClicked,colorView,md)
{
...
function _87(clickedSite){return(
clickedSite[Math.floor(clickedSite.length * 0.6)].date
)}
...
function _101(buoyDailyData){return(
buoyDailyData
)}

function _105(time1){return(
...
function _107(buoyDailyData){return(
buoyDailyData.filter((d) => d.category === "Strong")
)}

function _108(dateExtent){return(
...
function _113(dayBeforeStart){return(
dayBeforeStart
)}
...
function _numOfDates(d3,dateExtent){return(
...
function _130(opacityMHW){return(
opacityMHW("none")
)}
...
function _149(mhwBarData){return(
mhwBarData[0].date.slice(0, 7)
)}

function _150(d3,mhwBarData,allmonths,cats){return(
d3.sum(
  mhwBarData.filter((d) => +new Date(d.month) === +new Date(allmonths[0])),
  (d) => d[cats[1]]
)
)}

function _151(cats){return(
cats[0]
)}
...
function _153(monthlyTots){return(
monthlyTots.filter((d) => d.date === "2013-01")
)}

function _154(){return(
14410255 + 824985 + 3215 + 478
)}

function _155(allmonths){return(
allmonths
)}
...
function _157(groups){return(
groups
)}

function _158(){return(
12617969 + 1112284 + 34560 + 328
)}

function _159(groups){return(
groups[1][1]
)}

function _160(groups){return(
groups[1][1]
)}

function _161(groups){return(
groups[1][1].forEach((d) => {
  Object.values(d)[1];
})
)}

function _162(groups)
{
  let sum = 0;
  groups[1][1].forEach((d) => {
...
function _163(d3,groups){return(
d3.sum(groups[1][1], (d) => d[1])
)}
...
function _169(mhwBarData){return(
new Date(mhwBarData[0].date).getMonth()
)}

function _171(tt){return(
tt[20130101].reduce((a, b) => a + b, 0)
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([["monthly@5.json",new URL("./files/c4804cd494f0b96ac2d3b47dc33a672726905b0b035715b118da85af025b1b3bdfaca838961ca5e2847c4d71dd58f384bd53f4b3205dbdd64ff6d909a7c46815",import.meta.url)],["monthlyMHW.json",new URL("./files/4f15d9ec1bd1193a40e6cccc638b5ebbef045d555e511f1e5b1b631be853554576b6519c5cbbb167076801ccadcfb6c355a2ccc8f3cdbedc96be1debbb74c2e2",import.meta.url)]]);
  ...
  main.variable(observer()).define(["time1"], _7);
  ...
  main.variable(observer()).define(["alldates"], _14);
  main.variable(observer("x1MHW")).define("x1MHW", ["d3","margin","width","brusedAllDatesMHW"], _x1MHW);
  main.variable(observer()).define(["brusedAllDatesMHW"], _16);
  ...
  main.variable(observer()).define(["brushedData"], _22);
  main.variable(observer()).define(["dateExtent"], _23);
  main.variable(observer()).define(["time1"], _24);
  main.variable(observer("drag")).define("drag", ["d3","x","focus","today","datesToPlot","viewof time1"], _drag);
  ...
  main.variable(observer()).define(["cats"], _29);
  main.variable(observer()).define(["groups"], _30);
  main.variable(observer()).define(["monthlyTots"], _31);
  main.variable(observer()).define(["mhwBarData"], _32);
  main.variable(observer()).define(["colors"], _33);
  main.variable(observer()).define(["data"], _34);
  main.variable(observer()).define(["mhwBarData"], _35);
  main.variable(observer()).define(["stack","mhwBarData"], _36);
  main.variable(observer()).define(["mhwBarData"], _37);
  main.variable(observer("stack")).define("stack", ["d3","cats"], _stack);
  main.variable(observer()).define(["stack","brushedDataMHW"], _39);
  main.variable(observer()).define(["mhwBarData"], _40);
  main.variable(observer()).define(["cats"], _41);
  main.variable(observer()).define(["dateExtent"], _42);
  main.variable(observer()).define(["monthlyGrouped"], _43);
  main.variable(observer()).define(["stack","monthlyGrouped"], _44);
  main.variable(observer()).define(["brusedAllDatesMHW"], _45);
  main.variable(observer("brushedData")).define("brushedData", ["data","focus"], _brushedData);
  main.variable(observer()).define(["brusedAllDates"], _47);
  main.variable(observer()).define(["colorView"], _48);
  ...
  main.variable(observer()).define(["stack","brushedDataMHW"], _51);
  ...
  main.variable(observer()).define(["d3","today"], _58);
  ...
  main.variable(observer()).define(["dates"], _63);
  main.variable(observer()).define(["time1"], _64);
  main.variable(observer()).define(["alldates"], _65);
  ...
  main.variable(observer()).define(["colorView"], _68);
  ...
  main.variable(observer()).define(["Plot"], _76);
  ...
  main.variable(observer()).define(["time1"], _78);
  main.variable(observer()).define(["time1"], _79);
  main.variable(observer()).define(["clickedSite"], _80);
  main.variable(observer()).define(["Inputs","clickedSite"], _81);
  main.variable(observer("currentValue")).define("currentValue", ["clickedSite","time1"], _currentValue);
  main.variable(observer("viewof lineChart")).define("viewof lineChart", ["Plot","limitsDelayed","yMaxDomainToUse","clickedSite","time1","d3","dateForLabel","yValueForLabel","buoyClicked","colors","dateForLabelVal","currentValue","siteClicked","colorView","md"], _lineChart);
  ...
  main.variable(observer()).define(["clickedSite"], _87);
  ...
  main.variable(observer("cmColors")).define("cmColors", ["cmBalance"], _cmColors);
  main.variable(observer("cmBalance")).define("cmBalance", _cmBalance);
  ...
  main.variable(observer()).define(["buoyDailyData"], _101);
  main.variable(observer()).define(["time1"], _105);
  main.variable(observer("HWsForDate")).define("HWsForDate", ["buoyDailyData","time1"], _HWsForDate);
  main.variable(observer()).define(["buoyDailyData"], _107);
  main.variable(observer()).define(["dateExtent"], _108);
  ...
  main.variable(observer()).define(["dayBeforeStart"], _113);
  ...
  main.variable(observer("numOfDates")).define("numOfDates", ["d3","dateExtent"], _numOfDates);
  main.variable(observer("height")).define("height", _height);
  main.variable(observer("colorMHW")).define("colorMHW", ["d3"], _colorMHW);
  main.variable(observer()).define(["opacityMHW"], _130);
  ...
  main.variable(observer()).define(["mhwBarData"], _149);
  main.variable(observer()).define(["d3","mhwBarData","allmonths","cats"], _150);
  main.variable(observer()).define(["cats"], _151);
  main.variable(observer("allmonths")).define("allmonths", ["mhwBarData"], _allmonths);
  main.variable(observer()).define(["monthlyTots"], _153);
  main.variable(observer()).define(_154);
  main.variable(observer()).define(["allmonths"], _155);
  main.variable(observer("monthlyTots")).define("monthlyTots", ["allmonths","cats","d3","mhwBarData"], _monthlyTots);
  main.variable(observer()).define(["groups"], _157);
  main.variable(observer()).define(_158);
  main.variable(observer()).define(["groups"], _159);
  main.variable(observer()).define(["groups"], _160);
  main.variable(observer()).define(["groups"], _161);
  main.variable(observer()).define(["groups"], _162);
  main.variable(observer()).define(["d3","groups"], _163);
  ...
  main.variable(observer()).define(["mhwBarData"], _169);
  main.variable(observer()).define(["tt"], _171);
