import define1 from "./41364653f34651d0@302.js";
...
d3.timeDay.offset(today, -365)
  ...
  main.variable(observer("eventText")).define("eventText", ["md","textcolor"], function(md,textcolor){return(
md`${textcolor("marine heat wave events", "rgba(201, 37, 41,.7)")}`
)});
  main.variable(observer()).define(["limits"], function(limits){return(
limits
)});
  main.variable(observer("brushFilterX")).define("brushFilterX", ["d3","width","alldates","hwEvent","Promises","Event"], function(d3,width,alldates,hwEvent,Promises,Event){return(
function (
  extent,
  {
    defaultExtent,
